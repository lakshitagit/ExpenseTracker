...
const CATEGORIES = [
    ...
    {id:"other",name:"Other",icon:"ellipsis-horizational"},
];
const CreateScreen = () => {
    ...
    <View style={styles.container}>
        ...
        <View style={styles.card}>
            ...
            <View style={styles.inputContainer}>
                ...
                <TextInput style={styles.input} placeholder='Transaction Title' placeholderTextColor={COLORS.textLight} value={title} onChangeText={setTitle}></TextInput>
            </View>
